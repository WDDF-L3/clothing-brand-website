...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MH Clothing Brand'); ?> — Clothing Brand</title>
...
<header class="site-header">
    <div class="container">
        <nav class="nav-inner">
            <a href="<?php echo e(route('home')); ?>" class="brand">Clothing Brand</a>

            <ul class="nav-links">
                <li><a href="<?php echo e(route('shop')); ?>">Shop</a></li>
                <li><a href="<?php echo e(route('products.category', 'women')); ?>">Women</a></li>
                <li><a href="<?php echo e(route('products.category', 'men')); ?>">Men</a></li>
                <li><a href="<?php echo e(route('products.category', 'bags')); ?>">Bags</a></li>
                <li><a href="<?php echo e(route('products.category', 'shoes')); ?>">Shoes</a></li>
            </ul>

            <div class="nav-actions">
                <form action="<?php echo e(route('shop')); ?>" method="GET" class="search-form">
...
<?php if (! empty(trim($__env->yieldContent('no-catbar')))): ?>
<?php else: ?>
<div class="cat-bar">
    <div class="container">
        <ul>
            <li><a href="<?php echo e(route('shop')); ?>" class="<?php echo e(request()->routeIs('shop') && !request('category') ? 'active' : ''); ?>">All</a></li>
            <li><a href="<?php echo e(route('products.category', 'women')); ?>" class="<?php echo e(request()->is('category/women') ? 'active' : ''); ?>">Women</a></li>
            <li><a href="<?php echo e(route('products.category', 'men')); ?>" class="<?php echo e(request()->is('category/men') ? 'active' : ''); ?>">Men</a></li>
            <li><a href="<?php echo e(route('products.category', 'bags')); ?>" class="<?php echo e(request()->is('category/bags') ? 'active' : ''); ?>">Bags</a></li>
            <li><a href="<?php echo e(route('products.category', 'shoes')); ?>" class="<?php echo e(request()->is('category/shoes') ? 'active' : ''); ?>">Shoes</a></li>
        </ul>
    </div>
</div>
<?php endif; ?>
...
<footer>
    <div class="container">
        ...
        <div class="footer-bottom">
            <span>&copy; <?php echo e(date('Y')); ?> Maison Mode. All rights reserved.</span>
...
<?php /**PATH E:\New folder (2)\fashion-store\fashion-store\resources\views/layouts/app.blade.php ENDPATH**/ ?>